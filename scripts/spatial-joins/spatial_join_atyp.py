# -*- coding: utf-8 -*-
"""
Created on Thu Jan 30 16:32:48 2020
...
target_features = "NYCManhattan_Pop"
join_features = "NYCManhattan_IPUMS_proj"
out_features = "NYC_irish_german_atyp"
...
join_fields = ["atyp_GFW","atyp_IFW"]

#Set merge rules
#Rule should be "Sum", so we get the count of people with that trait on the block
for attribute in join_fields:
...
for field in arcpy.ListFields(join_features):
    if ((field.name not in join_fields) and not(field.required)):
